...
function showFunnel(inputSector) {
  var url5 = "symbol_performance/10/"+inputSector
  d3.json(url5).then(function(symbolPerfData) {
    ...
    var title = "10-Year Stocks Performance for "+inputSector
    var layout = {
      title: {'text': title,
              'color': '#0c3e57',
              'xanchor': 'center'
    ...
    Plotly.newPlot("funnel", data, layout, config, {displayModeBar: false});
  });
}
